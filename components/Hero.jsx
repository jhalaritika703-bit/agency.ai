...
const Hero = () => {
  return (
    ...
    >
      ...
      viewport={{once:true}}
      className='text-sm sm:text-lg font-medium text-gray-500 dark:text-white/75 max-w-4/5 sm:max-w-lg pb-3'>Creating meaningful connections and turning big ideas into intractive gigital experiences.</motion.p>
      ...
      className='relative'>
        <img src={assets.hero_img} alt="" className='w-full max-w-6xl'></img><img src={assets.bgImage1} alt="" className='absolute -top-40 -right-40 sm:-top-100 sm:-right-70 -z-1 dark:hidden'></img>
      </motion.div>
    </div>
  );
};
